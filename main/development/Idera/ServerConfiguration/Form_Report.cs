...
namespace Idera.SqlAdminToolset.ServerConfiguration
{
    public partial class Form_Report : Form
    {
        ...
        private void Form_Report_Load(object sender, System.EventArgs e)
        {
            ...
            reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("Idera_SqlAdminToolset_ServerConfiguration_ServerConfiguration_ReportData", m_dataSet.Tables[0]));
