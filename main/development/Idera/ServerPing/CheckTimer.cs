...
namespace Idera.SqlAdminToolset.ServerPing
{
   ...
   /// </summary>
   public class CheckTimer : IDisposable
   {
      ...
      /// <summary>
      /// Constructor for the CheckTimer class.  We do not start the timer
         ...
         int           interval )
      {
         ...
         _interval        = interval ;
         _handler         = callback ;
         _timer           = new System.Timers.Timer((new TimerCallback(TimerCallbackMethod), null, Timeout.Infinite, interval) ;
         _state           = 0 ;
         _timer.AutoReset = false;
      }

      public CheckTimer(TimerCallback callback) : this(callback, Timeout.Infinite) { }

      public CheckTimer(int interval) : this(null, interval) { }
      ...
      public virtual void Start(int msDelay)
      {
         ...
         if(_timer == null)
         {
            _timer = new System.Timers.Timer(new TimerCallback(TimerCallbackMethod), null, msDelay, _interval) ;
         }
         else
         {
