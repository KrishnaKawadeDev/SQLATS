...
namespace Idera.SqlAdminToolset.PatchEditor
{
   public class SQLServerVersion
   {
        ...
        public bool SameAs( SQLServerVersion other )
        {
           bool same = true;
           ...
           if ( this.Version       != other.Version ||
                ...
                this.SupportStatus != other.SupportStatus ||
                this.UrlType       != other.UrlType ||
                this.Url           != other.Url ||
                this.KbTitle       != other.KbTitle ||
           ...
           )
        {
           ...
           if ( ( SqlServerVersionList[index1].m_major == SqlServerVersionList[index2].m_major ) && 
                  ...
                  while (textReader.Read())
                  {
                     if ( textReader.NodeType == XmlNodeType.Element )
                     {
                        ...
                        else if ( textReader.Name == "Version" )
                        {
                           ...
                           string versionName = textReader.GetAttribute("VersionName");
           ...
           CheckForNewFile()
        {
         ...
         string tempFile = SQLServerVersion.GetTempPatchFilePath();
            ...
            {
               Messaging.ShowException( "An error occurred checking the latest Build List version on the Idera website. Patch Analyzer will continue using the current Build List.", ex );
               return false;
            }
