...
rem _____________________________________________________________________
"c:\program files\Absolute Packager\absolute.exe" /abs InstallationKit.abs /build Temp\IderaSQladmintoolsetInstallationKit.exe /silent /zip Temp\SQLadmintoolset.zip
